...
const krishna = () => {
  return (
    <main>
      ...
      <span className="text-3xl font-bold p-5 text-blue-500 font-urban md:ml-40 text-nowrap">KRISHNA</span>
        <div>
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-20 max-w-4xl">
        ...
        <div className="flex justify-start md:justify-start w-full md:w-auto">
          <p className="text-lg text-start md:text-left text-white">
            I am a Management and Marketing professional with a passion for reaching out to people and creating a brand image. I have experience with Marketing, Sales, and Management. I am always looking for new projects to work on and new skills to learn.
          </p>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="flex flex-wrap justify-center">
        <div className="bg-gray-800 text-white px-4 py-2 m-2 rounded-full">Marketing</div>
        <div className="bg-gray-800 text-white px-4 py-2 m-2 rounded-full">People Skill</div>
        <div className="bg-gray-800 text-white px-4 py-2 m-2 rounded-full">Management</div>
      </div>
    </div>
